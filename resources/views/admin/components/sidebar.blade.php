...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <div class="menu-section">
            ...
            {{-- Kegiatan Dropdown (BARU) --}}
            <div class="menu-dropdown">
                <div class="menu-item has-dropdown {{ $activeMenu === 'kegiatan' ? 'active' : '' }}" onclick="toggleDropdown(this)">
                    <div style="display: flex; align-items: center; gap: 1rem; flex: 1;">
                        <svg viewBox="0 0 24 24">
                ...
                <div class="submenu {{ $activeMenu === 'kegiatan' ? 'active' : '' }}">
                    <a href="{{ route('informasi-kegiatan') }}" class="submenu-item" target="_blank">
                        <svg viewBox="0 0 24 24">
                            <circle cx="12" cy="12" r="10" />
                            <line x1="2" y1="12" x2="22" y2="12" />
                            <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" />
                    ...
                    @if($admin->canManageContent())
                    <a href="{{ route('admin.kegiatan.index') }}" class="submenu-item {{ $activeMenu === 'kegiatan' ? 'active' : '' }}">
                        <svg viewBox="0 0 24 24">
                            <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
                            <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
                        </svg>
